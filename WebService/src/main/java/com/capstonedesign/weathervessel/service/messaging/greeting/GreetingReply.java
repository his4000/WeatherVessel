...
public class GreetingReply implements Reply {
    ...
    private final String greetingText = "안녕하세요.\n" +
            "2017 건국대학교 소프트웨어 융합학부 졸업 작품 Weather Vessel 팀 입니다.\n" +
    ...
    public Message getReplyMessage(String content, NaturalLanguageProcessing naturalLanguageProcessing, ObserveRepository observeRepository, AddressRepository addressRepository){
        return new Message(greetingText, new Photo("https://s3.amazonaws.com/poly-screenshots.angel.co/enhanced_screenshots/372687-original.jpg"));
    }
}
